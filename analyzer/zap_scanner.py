...
def configure_active_scanners(zap):
    ...
    injection_ids = [
        "40018", "40019", "40020", "40021", "40022", "40024", "40027",
        "90019", "90020", "90021", "90035", "90036", "40003", "90017",
        "90029", "40012", "40014", "40026", "40016", "40017",
    ]  # IDs for Injection
    ...
    for scanner_id in injection_ids + bac_ids:
        zap.ascan.set_scanner_alert_threshold(scanner_id, "MEDIUM")  # Adjust threshold as needed
        zap.ascan.set_scanner_attack_strength(scanner_id, "HIGH")  # Set strength for more aggressive checks
...
def scan_url(target, scan_depth=1):
    ...
    append_zap_results_to_consolidated_file(alerts)

    st.success("Scanning completed. Results saved to zap_scan_results.txt and consolidated_scan_results.md.")